...
namespace Core.Interfaces
{
    ...
    {
        Task<IReadOnlyList<Product>> GetProductsAsync(string? brand, string? model, string? sort); // Use IReadOnly since we are ONLY retrieving, not modifying our products returned
